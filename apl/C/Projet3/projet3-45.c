...
int chiffre3(int e1,int e2,int e3,int e4,int e5){
  if (e1>=e2 && e1<=e3 && e1<=e4 && e1>=e5 || e1<=e2 && e1>=e3 && e1<=e4 && e1>=e5 || e1<=e2 && e1<=e3 && e1>=e4 && e1>=e5 || e1>=e2 && e1>=e3 && e1<=e4 && e1<=e5 || e1<=e2 && e1>=e3 && e1>=e4 && e1<=e5)
    return e1;
  else if (e2>=e1 && e2<=e3 && e2<=e4 && e2>=e5 || e2<=e1 && e2>=e3 && e2<=e4 && e2>=e5 || e2<=e1 && e2<=e3 && e2>=e4 && e2>=e5 || e2>=e1 && e2>=e3 && e2<=e4 && e2<=e5 || e2<=e1 && e2>=e3 && e2>=e4 && e2<=e5)
    return e2;
  else if (e3>=e1 && e3<=e2 && e3<=e4 && e3>=e5 || e3<=e1 && e3>=e2 && e3<=e4 && e3>=e5 || e3<=e1 && e3<=e2 && e3>=e4 && e3>=e5 || e3>=e1 && e3>=e2 && e3<=e4 && e3<=e5 || e3<=e1 && e3>=e2 && e3>=e4 && e3<=e5)
    return e3;
  else if (e4>=e1 && e4<=e2 && e4<=e3 && e4>=e5 || e4<=e1 && e4>=e2 && e4<=e3 && e4>=e5 || e4<=e1 && e4<=e2 && e4>=e3 && e4>=e5 || e4>=e1 && e4>=e2 && e4<=e3 && e4<=e5 || e3<=e1 && e3>=e2 && e3>=e4 && e3<=e5)
    return e4;
  else if (e5>=e1 && e5<=e2 && e5<=e3 && e5>=e4 || e5<=e1 && e5>=e2 && e5<=e3 && e5>=e4 || e5<=e1 && e5<=e2 && e5>=e3 && e5>=e4 || e5>=e1 && e5>=e2 && e5<=e3 && e5<=e4 || e5<=e1 && e5>=e2 && e5>=e3 && e5<=e4)
    return e5;
}
