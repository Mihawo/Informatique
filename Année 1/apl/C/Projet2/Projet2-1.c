...
int main () {
 ...
 if (x1 < y1 && x1 < z1 || x1==y1 && x1<z1 || x1==z1 && x1<y1) 
   {
    pre1=x1;
    if (y1<z1) {
      deu1=y1;
  ...
  if (y1<x1 && y1<z1 || y1==x1 && y1<z1 || y1==z1 && y1<x1) {
    pre1=y1;
    if (x1<z1) {
      deu1=x1;
      tro1=z1; }
  ...
  if (z1<x1 && z1<y1 || z1==x1 && z1<y1 || z1==y1 && z1<x1) {
    pre1=z1;
    if (y1<x1) {
      deu1=y1;
      tro1=x1; }
  ...
  else pre1=x1, deu1=y1, tro1=z1;

  //Ordre croissant du joueur2
 if (x2<y2 && x2<z2 || x2==y2 && x2<z2 || x2==z2 && x2<y2) {
    pre2=x2;
    if (y2<z2) {
      deu2=y2;
      tro2=z2; }
  ...
  if (y2<x2 && y2<z2 || y2==x2 && y2<z2 || y2==z2 && y2<x2) {
    pre2=y2;
    if (x2<z2) {
      deu2=x2;
      tro2=z2; }
  ...
  if (z2<x2 && z2<y2 || z2==x2 && z2<y2 || z2==y2 && z2<x2) {
    pre2=z2;
    if (y2<x2) {
      deu2=y2;
      tro2=x2; }
  ...
  else if (pre1 == deu1 && deu1==tro1 && pre1==tro1)
    {
      if (pre2==deu2 && deu2==tro2 && pre2==tro2)
	{
	  if (pre1>pre2 || deu1>deu2 || tro1>tro2)
	    printf("Player1 wins\n");
	  else if (pre1==pre2 || deu1==deu2 || tro1==tro2)
	    printf("Draw\n");
	  else printf("Player2 wins\n");
		 }
      else printf("Player1 wins\n");
 ...
 //Combinaison spécial Fiche
  ...
  else if (pre1>pre2 || pre1==pre2 && deu1>deu2 || pre1==pre2 && deu1==deu2 && tro1>tro2)
    printf("Player1 wins\n");
  else if (pre1>pre2 || pre1==pre2 && deu1>deu2 || pre1==pre2 && deu1==deu2 && tro1==tro2)
    printf("Draw\n");
  else printf("Player2 wins\n");
